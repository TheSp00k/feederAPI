		...
		Request.app.models.client.findById(info.client.id, (err, clientInstance) => {
			...
			for (let i = 0; i < info.products.length; i++) {
				if (info.products[i].name) {
					...
					<tr style="text-align: left">
						<td colspan="5"><input style="-webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; border: 1px solid #d7d7d7;padding: 5px 10px;line-height: 30px;width: 100%;max-width: 100%;" name="feedbacks[${info.products[i].id}][commentheader]" id="title-${info.products[i].id}" type="text"></td>
					</tr>
					<tr style="text-align: left">
					...
					<tr style="text-align: left">
						<td colspan="5"><textarea style="-webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; border: 1px solid #d7d7d7;padding: 5px 10px;line-height: 30px;width: 100%; max-width: 100%;" name="feedbacks[${info.products[i].id}][commentcontent]" id="comment-${info.products[i].id}" rows="5"></textarea></td>
					</tr>
					<tr>
						<td colspan="5"><hr style="display: block; height: 1px; border: 0; border-top: 1px solid #ccc; margin: 3em 1em 3em 1em; padding: 0;"></td>
					</tr>`;
